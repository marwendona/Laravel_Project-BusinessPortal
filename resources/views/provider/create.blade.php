...
<form action="{{route('Provider.store')}}" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="nom_provider" id="nom_provider" value="{{ Auth::user()->name }}" class="form-control @error('nom_provider') border-danger @enderror" required>
    ...
    <input type="text" name="prenom_provider" id="prenom_provider" value="{{old('prenom_provider')}}" class="form-control @error('prenom_provider') border-danger @enderror" required>
    <br />
    ...
    <input type="number" name="phone_number" id="phone_number" value="{{old('phone_number')}}" class="form-control @error('phone_number') border-danger @enderror" required>
    <br />
    @error('phone_number')
    <div class="text text-danger">{{$message}}</div>
    @enderror
